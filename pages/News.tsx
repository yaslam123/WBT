        ...
        <div>
                ...
                <div className="relative">
                    <div className="container">
                        <div className="relative flex flex-col items-center bg-[url(/assets/images/world-map.png)] bg-cover bg-top bg-no-repeat lg:flex-row">
                            <div className="flex-1 py-10 text-center text-white ltr:lg:text-left rtl:lg:text-right"></div>
                            <div></div>
                        </div>
                    </div>
                </div>
            ...
            <section className="relative bg-gradient-to-t from-white/60 py-12 dark:bg-[#F6F8FD]/10 dark:from-transparent lg:py-24">
                ...
                <div className="container">
                    ...
                    <div className="flex flex-col gap-10 md:mt-0 lg:flex-row">
                        <div className="flex-1">
                            <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid0we557J7mshGFd4R69ziSg3zATyoqq2q553jGg1q1pca6f3F2P4XMVsSjDDYF96TTl?__cft__[0]=AZWlF6GqxyObPosScxj9olCBK-lvs_1Fs-UdVnyxJJMz_Q2vucGhHIIlbdvJbuRbTUiqhnguqKsn9h5pOXT_VmmF2lXA2Dn58P3_5oVrdBdcLCGtaBMB9_WV1DuNE1Gqgmqrtud5xce3nJn2KEN7Heez&__tn__=%2CO%2CP-R">
                                <div className="h-[243px] w-full overflow-hidden rounded-[20px]">
                                    <img src="/assets/images/new and events/news0.jpeg" className="w-full" alt="" />
                                </div>
                            </Link>
                            <div className="relative z-[1] mt-5 flex gap-4">
                                <div className="relative top-1/2 z-[1] flex h-[75px] w-[75px] flex-none flex-col items-center justify-center rounded-[10px] bg-black text-center text-white">
                                    <h3 className="text-[28px] font-extrabold leading-5">23</h3>
                                    <p className="text-xl font-extrabold">Mar</p>
                                </div>
                                <div>
                                    <h3 className="text-[24px] font-extrabold leading-7 text-black duration-200 hover:text-primary dark:text-white dark:hover:text-primary">
                                        <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid0we557J7mshGFd4R69ziSg3zATyoqq2q553jGg1q1pca6f3F2P4XMVsSjDDYF96TTl?__cft__[0]=AZWlF6GqxyObPosScxj9olCBK-lvs_1Fs-UdVnyxJJMz_Q2vucGhHIIlbdvJbuRbTUiqhnguqKsn9h5pOXT_VmmF2lXA2Dn58P3_5oVrdBdcLCGtaBMB9_WV1DuNE1Gqgmqrtud5xce3nJn2KEN7Heez&__tn__=%2CO%2CP-R">
                                            Xuska Malinta Biyaha
                                        </Link>
                                    </h3>
                                    <div className="mt-[14px] flex gap-6">
                                        Dabaaldegga Xuska Munaasabadda Maalinta Biyaha Adduunka ayaa ka socda maanta Magala madaxda caasimadda Galmudug ee
                                        Dhusamareb.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex-1 space-y-4">
                            <div className="group flex gap-3">
                                <div className="w-20 flex-none sm:w-[120px]">
                                    <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid02WWzGpquSJ1pxBBXnaGA95JvQ6r6KvGBrHhSCGqmyrSKGDAwKoJiktwGcCVKntrsnl?__cft__[0]=AZVZIb-vnr7y4LoRj69VpbRPH800j7JbXI2sfTNLIvf1CP-B9JrPm8TQ4LTIqtr2zd_pCXATjIUE_DyVLVbF-q6rvf7lcPyGp2IY2y-dlxrZGqmkYJzDlXgGcuven73a7rAEdBKLnHkJ4eg7JgM9TjdQM_VNANAfe-0htugpg9f7g0ylrPVSMZR5gRd5RAZy6oA&__tn__=%2CO%2CP-R">
                                        <div className="relative h-20 overflow-hidden rounded-[10px] sm:h-[120px]">
                                            <div className="absolute inset-0 flex scale-0 items-center justify-center bg-black/60 duration-500 group-hover:scale-100">
                                                <h5 className="text-[22px] font-extrabold text-white">
                                                    09 <br />
                                                    <span className="text-base font-extrabold">Apr</span>
                                                </h5>
                                            </div>
                                            <img src="/assets/images/new and events/news1.jpeg" className="h-full w-full object-cover" alt="" />
                                        </div>
                                    </Link>
                                </div>
                                <div>
                                    ...
                                    <p className="mt-2 text-base font-medium">
                                        Dhamaan Ummadda Soomaaliyeed iyo guud ahaan muslimiinta caalamka waxaan ugu hambalyaynaynaa munaasabada Ciidul Fidriga.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group flex gap-3">
                                <div className="w-20 flex-none sm:w-[120px]">
                                    <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid0zwQYM8mpYDkwCYGc363RRzPM8nMdqE2BD9eBR1UjCJ2tvujMEAfAry18nGLC2qQBl?__cft__[0]=AZWZzeHv9nU5UHU2cqXPhIk8cb9Hu9MTxT3MCzpildCfMGmHlhmcPK1oAGEN9UfgA6e3pL6dcuT0m_ETM6ZMVq7frM_a7DxhtZ4l_uvwXeSnUxhYRTJK5uNP4UITpSy1gcoWlQzDoVwGPDi4vLlrTIdjteUP-gpCujTSE0QwMXWnhfHH2IUUbaKssjCc578pmZU&__tn__=%2CO%2CP-R">
                                        <div className="relative h-20 overflow-hidden rounded-[10px] sm:h-[120px]">
                                            <div className="absolute inset-0 flex scale-0 items-center justify-center bg-black/60 duration-500 group-hover:scale-100">
                                                <h5 className="text-[22px] font-extrabold text-white">
                                                    23 <br />
                                                    <span className="text-base font-extrabold">Mar</span>
                                                </h5>
                                            </div>
                                            <img src="/assets/images/new and events/news2.jpeg" className="h-full w-full object-cover" alt="" />
                                        </div>
                                    </Link>
                                </div>
                                <div>
                                    ...
                                    <p className="mt-2 text-base font-medium">
                                        Halkudhigga Sanadkaan ayaa ah “ Biyuhu waa horseedka Nabadda”. Maanta waxaan u dabaal degeynaa Xuska maalinka Biyaha
                                        Adduunka sanada 2024.
                                    </p>
                                </div>
                            </div>
                            <div className="border border-dashed border-gray opacity-50"></div>
                            <div className="group flex gap-3">
                                <div className="w-20 flex-none sm:w-[120px]">
                                    <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid0by9oWnm9MZq7791EMy531Ct7qBzpepX8KCKpfyyfjAhAwzX8ha5rTftQ4URD7sGNl?__cft__[0]=AZXrpGkdvd5MiTrLAk7KC1oPdIyfU58XGoDjBJZKzicVg30I41zHw-xzRJOAoXG6OuH6K1Zc8XjWmmrgOxZ0mII-UdGSZZA-9wLGVuxA5jtnmYAF54d8nciXuqCV9OTDZuj01hv9felosZDWHyuNCUoOAvUD1LGcSIYMD1_iLvD_8nJJ_mgR_2euc-ahAK2rpZM&__tn__=%2CO%2CP-R">
                                        <div className="relative h-20 overflow-hidden rounded-[10px] sm:h-[120px]">
                                            <div className="absolute inset-0 flex scale-0 items-center justify-center bg-black/60 duration-500 group-hover:scale-100">
                                                <h5 className="text-[22px] font-extrabold text-white">
                                                    06 <br />
                                                    <span className="text-base font-extrabold">Feb</span>
                                                </h5>
                                            </div>
                                            <img src="/assets/images/new and events/news3.jpeg" className="h-full w-full object-cover" alt="" />
                                        </div>
                                    </Link>
                                </div>
                                <div>
                                    <h3 className="text-[22px] font-bold text-black duration-200 hover:text-primary dark:text-white dark:hover:text-primary">
                                        <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid0by9oWnm9MZq7791EMy531Ct7qBzpepX8KCKpfyyfjAhAwzX8ha5rTftQ4URD7sGNl?__cft__[0]=AZXrpGkdvd5MiTrLAk7KC1oPdIyfU58XGoDjBJZKzicVg30I41zHw-xzRJOAoXG6OuH6K1Zc8XjWmmrgOxZ0mII-UdGSZZA-9wLGVuxA5jtnmYAF54d8nciXuqCV9OTDZuj01hv9felosZDWHyuNCUoOAvUD1LGcSIYMD1_iLvD_8nJJ_mgR_2euc-ahAK2rpZM&__tn__=%2CO%2CP-R">
                                            Wasiirka wasarada Tamarta
                                        </Link>
                                    </h3>
                                    <p className="mt-2 text-base font-medium">
                                        Wasiirka wasarada Tamarta iyo khayradka biyaha Galmudug Mudane Abdulkadir Shire Warsame Galbeyte ayaa xafiiska wasaarada
                                        ku qaabilay wafdi
                                    </p>
                                </div>
                            </div>
            ...
            <section className="mb-12 dark:bg-none sm:p-5 lg:mb-24">
                <div className="mx-auto max-w-[1440px] rounded-[30px] bg-secondary py-12 dark:bg-gray-dark lg:py-24">
                    <div className="container">
                        <div className="flex flex-col gap-6 lg:flex-row" data-aos="fade-up" data-aos-duration="1000">
                            <div className="flex-1">
                                <div className="mb-[30px] flex gap-3">
                                    ...
                                    <h5 id="sheader" className="text-[40px] font-extrabold text-white">
                                        Our Latest Events
                                    </h5>
                                </div>
                                <div className="space-y-6">
                                    <div className="relative h-[306px] w-full overflow-hidden rounded-[10px]">
                                        <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid02Yh8Fxvd8ZU5rjtNornhEW5hiU9D4kDkSTFQYHDcuaUdr4ERUURvHCMwLdZPe3d7tl?__cft__[0]=AZWyETA9nA0dQuM0-617Nf5IMQa2rzprE0BQVGkaBC4YTbHQ1vMQJ6b9qJVK5AuFhR4I1BSMJ_XVLApgcSmdHflxjbIpbrUlyV3ozFkm_fmjkEV5RRNPnU0n3iRQiy30_R0Hg1H_os1JuTH9QGlfHI73qdxldxICLGfkIsSCemZlJhWUnOR2emqriDi2m3usQUM&__tn__=%2CO%2CP-R">
                                            <div className="absolute inset-0 bg-gradient-to-b from-[#000]/5 via-[#000]/60 to-[#000]/75"></div>
                                            <img src="/assets/images/new and events/Event2.jpeg" className="h-full w-full object-cover" alt="" />\
                                        </Link>

                                        <div className="absolute bottom-5 left-5 right-5">
                                            <Link
                                                href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid02Yh8Fxvd8ZU5rjtNornhEW5hiU9D4kDkSTFQYHDcuaUdr4ERUURvHCMwLdZPe3d7tl?__cft__[0]=AZWyETA9nA0dQuM0-617Nf5IMQa2rzprE0BQVGkaBC4YTbHQ1vMQJ6b9qJVK5AuFhR4I1BSMJ_XVLApgcSmdHflxjbIpbrUlyV3ozFkm_fmjkEV5RRNPnU0n3iRQiy30_R0Hg1H_os1JuTH9QGlfHI73qdxldxICLGfkIsSCemZlJhWUnOR2emqriDi2m3usQUM&__tn__=%2CO%2CP-R"
                                                className="text-xl font-bold text-white hover:text-primary dark:hover:text-primary"
                                            >
                                                Laas-Xaadoow, 1 Nov 2023
                                                <p className="mt-2 text-sm font-medium text-white">
                                                    Wasiirka wasaaradda wasaaradda Tamarta iyo kheyraadka biyaha galmudug mudane Abdulkadir Shire warsame
                                                    (Galbeyte) Oo uu wahliyo wasiirudulaha Wasaaradda Shaariif Mohamuud cali.
                                                </p>
                                            </Link>
                                        </div>
                                    </div>
                                    <div className="relative h-[306px] overflow-hidden rounded-[10px]">
                                        <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid0rqhCuTf9cykefrLeEeshczseisn2rmNTxxWWNxsLPhAMp3wdjH9VK2H4x7469EDxl?__cft__[0]=AZUye_NQFvPDqH_xP1epW5cXBD2ch_BSunENJ3vBkc2u7LGTvqcwXPoeCstg8JH4emaLNR_rMeWjwNuT5ETDN2YXMnJFNJeLYg8ZP-pv1sSTbXPVW1R6BH1_uLvvAHoibVYZI3eIgr0e4VQLSdIBFaC6u5QHXcuop-iFdierlTgY_bDM2HZjCGAIluGw5DmUz8A&__tn__=%2CO%2CP-R">
                                            <div className="absolute inset-0 bg-gradient-to-b from-[#000]/5 via-[#000]/60 to-[#000]/75"> </div>
                                            <img src="/assets/images/new and events/Event3.jpeg" className="h-full w-full object-cover" alt="" />
                                        </Link>
                                        <div className="absolute bottom-5 left-5 right-5">
                                            <Link
                                                href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid0rqhCuTf9cykefrLeEeshczseisn2rmNTxxWWNxsLPhAMp3wdjH9VK2H4x7469EDxl?__cft__[0]=AZUye_NQFvPDqH_xP1epW5cXBD2ch_BSunENJ3vBkc2u7LGTvqcwXPoeCstg8JH4emaLNR_rMeWjwNuT5ETDN2YXMnJFNJeLYg8ZP-pv1sSTbXPVW1R6BH1_uLvvAHoibVYZI3eIgr0e4VQLSdIBFaC6u5QHXcuop-iFdierlTgY_bDM2HZjCGAIluGw5DmUz8A&__tn__=%2CO%2CP-R"
                                                className="text-xl font-bold text-white hover:text-primary dark:hover:text-primary"
                                            >
                                                Ceel-Guula, 14 October 2023
                                            </Link>
                                            <p className="mt-2 text-sm font-medium text-white">
                                                Wasaarada Tamarta iyo kheyraadka Biyaha Galmudug ayaa xariga ka jartay mashruuca lagu tayeeynayay Bulshada
                                                Dagmada Ceelguula kaas oo uu maalgaliayay Midowga Yurub.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex-none lg:w-[470px]">
                                ...
                                <div className="space-y-6">
                                    <div className="relative h-[306px] w-full overflow-hidden rounded-[10px]">
                                        <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid04R1XuiZ3aTjGf4TjBSBmHJpNSj6JRmUiU3hwF15UMHCi5WnnjDkVtfspDiYM6WW3l?__cft__[0]=AZVRG04mLwkVeoNttRxjCYACrCGocoB20eIlESz7DL2WHVUnbDCdt5HWFNm6NfUBrMyhd2wpJxItlKErk7GzrQQTYczjOw0O8VnF6x-8kJ0biu9Ngd-cWBpirmw96ChLBDgOyZloPTcXJcRbcVYrBYD05_udYMaHaHqstpuj70DMz0nWOHqdx0cMahLHbIcx-G8&__tn__=%2CO%2CP-R">
                                            <div className="absolute inset-0 bg-gradient-to-b from-[#000]/5 via-[#000]/60 to-[#000]/75"></div>
                                            <img src="/assets/images/new and events/Event1.jpeg" className="h-full w-full object-cover" alt="" />
                                        </Link>
                                        <div className="absolute bottom-5 left-5 right-5">
                                            <Link
                                                href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid04R1XuiZ3aTjGf4TjBSBmHJpNSj6JRmUiU3hwF15UMHCi5WnnjDkVtfspDiYM6WW3l?__cft__[0]=AZVRG04mLwkVeoNttRxjCYACrCGocoB20eIlESz7DL2WHVUnbDCdt5HWFNm6NfUBrMyhd2wpJxItlKErk7GzrQQTYczjOw0O8VnF6x-8kJ0biu9Ngd-cWBpirmw96ChLBDgOyZloPTcXJcRbcVYrBYD05_udYMaHaHqstpuj70DMz0nWOHqdx0cMahLHbIcx-G8&__tn__=%2CO%2CP-R"
                                                className="text-xl font-bold text-white hover:text-primary dark:hover:text-primary"
                                            >
                                                Kampala, Oktober 26 2023
                                            </Link>
                                            <p className="mt-2 text-sm font-medium text-white">
                                                Agasimaha Guud ee wasarada Tamarta iyo kheeyraadka Biyaha Galmudug ayaa booqday wershedda sifeynta iyo bixinta
                                                biyaha dalka Uganda.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="relative h-[306px] overflow-hidden rounded-[10px]">
                                        <Link href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid02XJRKWPWnLXNYDHSmxdYHq5asPzsHX9BZ3KcthSBLQcYpFKEBm2qM6E7CSZV5eNv7l?__cft__[0]=AZWnL2FMpq7vQtH6Mv1I6dWdcNjViP6Qm3xaVefkex4hR7XUvUoRS0qN_r_wDpA3SocZerqb1xKH5VIBvmCHNSZChZeKDr_hd8sCgBrgkl3YDeP_KpNPk9ZF4wV6x5DOHoWWwQQMfnCm_kyIipeyfhbxUxkvK_CTovTDHoHkglREAStpK2iBcUMWwjIWnyopsmM&__tn__=%2CO%2CP-R">
                                            <div className="absolute inset-0 bg-gradient-to-b from-[#000]/5 via-[#000]/60 to-[#000]/75"></div>
                                            <img src="/assets/images/new and events/Event4.jpeg" className="h-full w-full object-cover" alt="" />
                                        </Link>
                                        <div className="absolute bottom-5 left-5 right-5">
                                            <Link
                                                href="https://www.facebook.com/WTKHBGalmudug/posts/pfbid02XJRKWPWnLXNYDHSmxdYHq5asPzsHX9BZ3KcthSBLQcYpFKEBm2qM6E7CSZV5eNv7l?__cft__[0]=AZWnL2FMpq7vQtH6Mv1I6dWdcNjViP6Qm3xaVefkex4hR7XUvUoRS0qN_r_wDpA3SocZerqb1xKH5VIBvmCHNSZChZeKDr_hd8sCgBrgkl3YDeP_KpNPk9ZF4wV6x5DOHoWWwQQMfnCm_kyIipeyfhbxUxkvK_CTovTDHoHkglREAStpK2iBcUMWwjIWnyopsmM&__tn__=%2CO%2CP-R"
                                                className="text-xl font-bold text-white hover:text-primary dark:hover:text-primary"
                                            >
                                                BAXDO, 7da August 2023
                                            </Link>
                                            <p className="mt-2 text-sm font-medium text-white">
                                                Wasiirka Wasarada Tamarta iyo khayradka biyaha Galmudug ayaa manta safar shaqo ku tagay degmada baxdo.{' '}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="container">
                    <div className="flex flex-col items-center justify-between gap-10 md:flex-row md:gap-0">
                        <div className="text-center ltr:md:text-left rtl:md:text-right">
                            <h6 className="mb-3 text-lg font-extrabold text-secondary sm:mb-4">ABOUT US</h6>
