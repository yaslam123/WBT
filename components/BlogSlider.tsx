...
const BlogSlider = ({
    ...
    Projects = [
        {
            id: 1,
            thumbnail: '/assets/images/project img/project1.jpeg',
            title: 'SESRP Project',
            excerpt: ' This Project aim to empower individuals and communities on thier journey of rcovery.',
            description:
                'The state of Galmudg, The Ministry of Energy and Water Resources is implementing the States Electricity Sector Recovery Project, The Project Development Objective is to increase access to lower cost and cleaner electricity supply in the project areas and to Re-establish the electricity supply industry',
        },
        {
            id: 2,
            thumbnail: '/assets/images/project img/project2.jpeg',
            title: 'ASCENT Project',
            excerpt: 'The Project Development is to increase access to clean energy through private sector participation in Galmudug',
            description:
        ...
        {
            id: 3,
            thumbnail: '/assets/images/project img/IWRM-SIDA project.jpg',
            title: 'IWRM-SIDA Project',
            excerpt: ' Within the integrated approach to promoting sustainable and resilient development in Galmudug.',
            description:
        ...
        {
            id: 4,
            thumbnail: '/assets/images/project img/IWRM-GEF-Project.jpg',
            title: 'IWRM-GEF Project',
            excerpt: 'National water resource management policy establishing clear national.',
            description:
                            ...
                            return (
                                <SwiperSlide key={Projects.id}>
                                    <div className="relative rounded-3xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark">
                                        ...
                                        <img src={Projects.thumbnail} alt="" className="h-52 w-full rounded-t-3xl object-cover" />
                                        <div className="p-5 text-sm font-bold">
                                            <h6 className="font-extrabold text-secondary dark:text-secondary">{Projects.title}</h6>
                                            <h5 className="my-[10px] block text-lg font-extrabold leading-[23px] text-black line-clamp-2 dark:text-white">
                                                {Projects.excerpt}
                                            </h5>
                                            <p className="line-clamp-4">{Projects.description}</p>
                                        </div>
                                    </div>
                                </SwiperSlide>
                            );
                            ...
                            return (
                                <SwiperSlide key={Projects.id}>
                                    <div className="rounded-3xl bg-white dark:bg-gray-dark">
                                        <img src={Projects.thumbnail} alt="Projects-3" className="h-52 w-full rounded-t-3xl object-cover" />
                                        <div className="p-5 text-sm font-bold">
                                            <span className="rounded bg-primary/10 py-1 px-2 text-sm font-extrabold text-primary">{Projects.tag}</span>
                                            <Link
                                                href="/Projects"
                                            ...
                                            <p className="line-clamp-3">{Projects.excerpt}</p>
