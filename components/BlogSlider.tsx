                            ...
                            return (
                                <SwiperSlide key={blog.id}>
                                    <div className="relative rounded-3xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark">
                                        <Link href="/blog" className="absolute top-0 h-full w-full ltr:left-0 rtl:right-0"></Link>
                                        <img src={blog.thumbnail} alt="" className="h-52 w-full rounded-t-3xl object-cover" />
